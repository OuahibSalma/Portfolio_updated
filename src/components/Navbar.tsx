...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {isMobile && (
        <Button
          className="fixed top-4 left-4 z-50 w-10 h-10 p-2 rounded-md bg-white dark:bg-gray-800 shadow-md"
      ...
      >
        <div className={`flex flex-col h-full justify-between py-4 px-2 bg-white dark:bg-gray-800 shadow-md ${
              ...
              {navItems.map((item) => (
                <li key={item.name} className="w-full">
                  <a 
                    ...
                    className="flex items-center gap-3 py-3 px-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-gray-800 dark:text-white"
                  >
                    <item.icon size={24} />
          ...
          <div className="flex flex-col gap-2 items-start px-2 mt-2">
            <button 
